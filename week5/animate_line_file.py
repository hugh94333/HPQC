...
def main():
    """
    Usage:
        python3 animate_line_file.py input.csv output.gif

    Example:
        python3 animate_line_file.py data/string_wave.csv result.gif
    """
    ...
    try:
        ...
        print("Usage: python3 animate_line_file.py input.csv output.gif")
        exit(1)
